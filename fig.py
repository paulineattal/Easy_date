...
class Fig :
    ...
    def get_fig_sunburst_men(self):
        return px.sunburst(self.__df_men, title="Hommes", path=['most_interest', 'goal_cat', 'age_cat'],values='exphappy', color='exphappy').update_layout({'plot_bgcolor':'rgb(39, 43, 48)', 'paper_bgcolor':'rgb(39, 43, 48)'})
    
    def get_fig_sunburst_women(self):
        return px.sunburst(self.__df_women, title="Femmes", path=['most_interest', 'goal_cat', 'age_cat'],values='exphappy', color='exphappy').update_layout({'plot_bgcolor':'rgb(39, 43, 48)', 'paper_bgcolor':'rgb(39, 43, 48)'})
